...
public abstract class AbstractMarketApi {
    ...
    public  abstract JSONObject ticker2(SymbolPair symbol) throws IOException ;
    ...
    class PriceComparator implements Comparator<Object> {
        public int compare(Object member1, Object member2) {
            //compareTo锛屼袱涓璞″睘鎬т箣闂寸殑姣旇緝锛岃繑鍥炶礋鏁帮紝0鍜屾鏁�            return Double.compare(Double.parseDouble(((JSONArray) member1).get(0).toString()),
        	return	(int)   Double.parseDouble(((JSONArray) member2).get(0).toString());
        }
    }

    class ReversePriceComparator implements Comparator<Object> {
        public int compare(Object member1, Object member2) {
            //compareTo锛屼袱涓璞″睘鎬т箣闂寸殑姣旇緝锛岃繑鍥炶礋鏁帮紝0鍜屾鏁�       
  //      	return Double.compare(Double.parseDouble(((JSONArray) member2).get(0).toString()),
               	JSONArray memberarray=(JSONArray) member1;
//        	
                return	(int) Double.parseDouble(memberarray.get(0).toString());
