...
public class PeatioCNYApiTest {
    ...
    private AppAccount getAppAccount() {
        ...
        appAccount.setId(1L);
        appAccount.setAccessKey("Zjmwm3M44pIy5dlt9SoeSdbqiEp67F9ZmnkHnSnE"); // todo 替换为access_key
        appAccount.setSecretKey("ziOeO3NNuxwxYtnEF4XhzCqmzJevYhjHIwSPDpPx"); // todo 替换为secret_key
        return appAccount;
    }
    ...
    public void testBuyAndCancel() throws Exception {
        ...
        Long orderId = market.buy(getAppAccount(), amount, price, new SymbolPair(Symbol.ltc, Symbol.usd));
